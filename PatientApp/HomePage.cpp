...
{
    winrt::Windows::Foundation::Collections::IObservableVector<winrt::PatientApp::Patient> HomePage::PatientsList()
    {
    ...
    void HomePage::PatientsList(winrt::Windows::Foundation::Collections::IObservableVector<winrt::PatientApp::Patient> const& value)
    {
